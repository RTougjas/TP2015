...
SELECT pictures.id, pictures.title AS picture_title, pictures.description AS picture_description, pictures.location, pictures.publicpic, pictures.user_id AS uploader_id,
